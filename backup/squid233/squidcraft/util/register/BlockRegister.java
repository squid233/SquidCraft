...
import io.github.squid233.squidcraft.api.BlockRegistries;
...
public class BlockRegister {
    ...
    private static Block register(String name, Block block, Item.Settings settings) {
        return BlockRegistries.register(SquidCraft.MODID, name, block, settings);
    }
    ...
    private static Block register(String name, Block block) {
        return BlockRegistries.register(SquidCraft.MODID, name, block);
    }

    private void register(String name, Block block, ItemBlock itemBlock) {
        ItemRegistries.register(SquidCraft.MODID, name, itemBlock);
        if (Loggers.enableRegisterLog) {
            SquidCraft.debug("register " + SquidCraft.MODID + ":" + name + " block success!");
        }
        Registry.register(Registry.BLOCK, new Identifier(name), block);
    }
    ...
    public static final Identifier BIGGER_CHEST = new Identifier("bigger_chest_block");
