...
public class BlockRegister {
    ...
    static
    {
        COPPER_ORE = register("copper_ore", new CopperOre(FabricBlockSettings.of(Material.STONE).strength(3.0f, 3.0f).breakByTool(FabricToolTags.PICKAXES, 3)), new Item.Settings().group(ItemGroups.SQUID_CRAFT));
        COPPER_BLOCK = register("copper_block", new CopperBlock(FabricBlockSettings.of(Material.METAL).strength(5.0f, 6.0f).breakByTool(FabricToolTags.PICKAXES, 3).sounds(BlockSoundGroup.METAL)), new Item.Settings().group(ItemGroups.SQUID_CRAFT));

        // Squid blocks begin
        SQUID_BLOCK = register("squid_block", new SquidBlock(FabricBlockSettings.of(Material.EARTH).hardness(0.5f)), new SquidBlockItem(new Item.Settings().group(ItemGroups.SQUID_CRAFT).food(new FoodComponent.Builder().hunger(1458).saturationModifier(165.651f).meat().alwaysEdible().build())));
        COMPRESS_SQUID_BLOCK = register("compress_squid_block", new CompressSquidBlock(FabricBlockSettings.of(Material.EARTH).hardness(0.525f)), new Item.Settings().group(ItemGroups.SQUID_CRAFT).food(new FoodComponent.Builder().hunger(13122).saturationModifier(256.0f).meat().alwaysEdible().build()));
        LOW_SQUID_BLOCK = register("low_squid_block", new LowSquidBlock(FabricBlockSettings.of(Material.EARTH).strength(0.55f, 0.1f)), new Item.Settings().group(ItemGroups.SQUID_CRAFT).food(new FoodComponent.Builder().hunger(118098).saturationModifier(512.0f).meat().alwaysEdible().build()));
        LOW_COMPRESS_SQUID_BLOCK = register("low_compress_squid_block", new LowCompressSquidBlock(FabricBlockSettings.of(Material.EARTH).strength(0.6f, 0.15f)), new Item.Settings().group(ItemGroups.SQUID_CRAFT).food(new FoodComponent.Builder().hunger(1062882).saturationModifier(1024.0f).meat().alwaysEdible().build()));
        MEDIUM_SQUID_BLOCK = register("medium_squid_block", new MediumSquidBlock(FabricBlockSettings.of(Material.EARTH).strength(0.65f, 0.2f)), new Item.Settings().group(ItemGroups.SQUID_CRAFT).food(new FoodComponent.Builder().hunger(1417176).saturationModifier(1365.3f).meat().alwaysEdible().build()));
        MEDIUM_COMPRESS_SQUID_BLOCK = register("medium_compress_squid_block", new MediumCompressSquidBlock(FabricBlockSettings.of(Material.EARTH).strength(0.7f, 0.25f)), new Item.Settings().group(ItemGroups.SQUID_CRAFT).food(new FoodComponent.Builder().hunger(1889568).saturationModifier(1820.4f).meat().alwaysEdible().build()));
        HIGHER_SQUID_BLOCK = register("higher_squid_block", new HigherSquidBlock(FabricBlockSettings.of(Material.EARTH).strength(0.75f, 0.3f)), new Item.Settings().group(ItemGroups.SQUID_CRAFT).food(new FoodComponent.Builder().hunger(2519424).saturationModifier(2427.2f).meat().alwaysEdible().build()));
        HIGHER_COMPRESS_SQUID_BLOCK = register("higher_compress_squid_block", new HigherCompressSquidBlock(FabricBlockSettings.of(Material.EARTH).strength(0.8f, 0.35f)), new Item.Settings().group(ItemGroups.SQUID_CRAFT).food(new FoodComponent.Builder().hunger(3359232).saturationModifier(3236.266666666666f).meat().alwaysEdible().build()));
        SUPER_SQUID_BLOCK = register("super_squid_block", new SuperSquidBlock(FabricBlockSettings.of(Material.EARTH).strength(0.85f, 0.4f)), new Item.Settings().group(ItemGroups.SQUID_CRAFT).food(new FoodComponent.Builder().hunger(4478976).saturationModifier(4315.023f).meat().alwaysEdible().build()));
        SUPER_COMPRESS_SQUID_BLOCK = register("super_compress_squid_block", new SuperCompressSquidBlock(FabricBlockSettings.of(Material.EARTH).strength(0.9f, 0.45f)), new Item.Settings().group(ItemGroups.SQUID_CRAFT).food(new FoodComponent.Builder().hunger(5971968).saturationModifier(5753.3629629629629629629629629631f).meat().alwaysEdible().build()));
        ULTIMATE_SQUID_BLOCK = register("ultimate_squid_block", new UltimateSquidBlock(FabricBlockSettings.of(Material.EARTH).strength(0.95f, 0.5f)), new Item.Settings().group(ItemGroups.SQUID_CRAFT).food(new FoodComponent.Builder().hunger(7962624).saturationModifier(7671.15061728395f).meat().alwaysEdible().build()));
        ULTIMATE_COMPRESS_SQUID_BLOCK = register("ultimate_compress_squid_block", new UltimateCompressSquidBlock(FabricBlockSettings.of(Material.EARTH).strength(1.0f, 0.55f)), new Item.Settings().group(ItemGroups.SQUID_CRAFT).food(new FoodComponent.Builder().hunger(10616832).saturationModifier(10228.200823045267489711934156379f).meat().alwaysEdible().build()));
        // Squid blocks end
        ...
        SQUID_SIDE_BLOCK = register("squid_side_block", new SquidSideBlock(FabricBlockSettings.of(Material.EARTH).hardness(1.5f)), new Item.Settings().group(ItemGroups.SQUID_CRAFT).food(new FoodComponent.Builder().hunger(729).saturationModifier(82.8255f).meat().alwaysEdible().build()));
