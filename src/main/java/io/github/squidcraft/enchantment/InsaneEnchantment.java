...
public class InsaneEnchantment extends Enchantment {
    ...
    public void onUserDamaged(LivingEntity user, Entity attacker, int level) {
        ...
        user.addStatusEffect(new StatusEffectInstance(StatusEffects.BAD_OMEN));
        user.addStatusEffect(new StatusEffectInstance(StatusEffects.BLINDNESS));
        user.addStatusEffect(new StatusEffectInstance(StatusEffects.CONDUIT_POWER));
        user.addStatusEffect(new StatusEffectInstance(StatusEffects.DOLPHINS_GRACE));
        ...
        user.addStatusEffect(new StatusEffectInstance(StatusEffects.HEALTH_BOOST));
        user.addStatusEffect(new StatusEffectInstance(StatusEffects.HERO_OF_THE_VILLAGE));
        user.addStatusEffect(new StatusEffectInstance(StatusEffects.HUNGER));
        user.addStatusEffect(new StatusEffectInstance(StatusEffects.INSTANT_DAMAGE));
        user.addStatusEffect(new StatusEffectInstance(StatusEffects.INSTANT_HEALTH));
        user.addStatusEffect(new StatusEffectInstance(StatusEffects.INVISIBILITY));
        ...
        user.addStatusEffect(new StatusEffectInstance(StatusEffects.MINING_FATIGUE));
        ...
        user.addStatusEffect(new StatusEffectInstance(StatusEffects.POISON));
        ...
        user.addStatusEffect(new StatusEffectInstance(StatusEffects.SATURATION));
        user.addStatusEffect(new StatusEffectInstance(StatusEffects.SLOW_FALLING));
        ...
        user.addStatusEffect(new StatusEffectInstance(StatusEffects.UNLUCK));
        user.addStatusEffect(new StatusEffectInstance(StatusEffects.WATER_BREATHING));
        user.addStatusEffect(new StatusEffectInstance(StatusEffects.WEAKNESS));
        user.addStatusEffect(new StatusEffectInstance(StatusEffects.WITHER));
